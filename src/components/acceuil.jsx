    ...
    <div className={s.container}>
      ...
      <div className={`${s.tuto}`}>
        ...
        <div className=" fadeIn2">
          ...
          <p>Le robot se déplace de manière autonome jusqu'à la destination.</p>
        </div>
        <div className=" fadeIn2">
      ...
      <p className="fadeIn">
        CarryBot est un robot mobile autonome conçu par des étudiants de l'ISPM.
        Il permet d'effectuer des livraisons à courte distance, en se déplaçant
        de façon autonome tout en évitant les obstacles. Notre objectif est de
        démontrer comment la robotique et le web peuvent collaborer pour
